export default function Character({character}) {
    ...
    return (
        <article className="flex flex-col h-full w-full max-w-[400px] self-center justify-self-center bg-blue-700 border-2 border-transparent transition-colors duration-200 hover:border-blue-400">
            ...
            <p className="flex flex-col items-center py-3">
                ...
                <span className="text-gray-300">First seen in {firstSeen} episode</span>
            </p>
        </article>
    )
}
